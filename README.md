...
| 分类             | 功能说明 |
|------------------|----------|
| **启动与弹窗**   | 跳过开屏广告<br>屏蔽营销弹窗<br>屏蔽通知开启引导 |
| **首页**         | 隐藏顶部话题栏<br>屏蔽首页轮播广告<br>隐藏「Jumper 热议」卡片<br>屏蔽推荐流与帖子内嵌广告<br>屏蔽 Jump 小酱推广贴<br>隐藏发布按钮 |
| **发现页**       | 屏蔽顶部广告<br>屏蔽轮播广告 |
| **内容与详情**   | 允许长按复制文本<br>恢复帖子完整年份<br>查看游戏评价总结 |
| **个人中心**     | 隐藏 Jump+ 会员卡片<br>隐藏「我的订单」<br>隐藏截图展示墙 |
| **底栏与小组件** | 隐藏底栏「Jump 赏」<br>隐藏底栏「抽奖 / 全新 App」<br>隐藏小组件会员标识 |
| **个性化与拓展** | 开启调试日志<br>屏蔽帖子指定关键词<br>更换 App 图标（修复官方遗漏图标，含 21 款）<br>更多细项开关与实用特性，请在模块设置面板中自行探索与配置 |
...
本项目仅供个人技术研究与学习交流使用，与 Jump 官方无任何隶属关系。  
使用本项目请遵循相关法律法规及服务条款，由此产生的任何后果由使用者自行承担。
